...
class HaproxyServiceConfiguration(object):
    start_command = None
    stop_command = None
    wait_command = None
...
class HaproxyProxyServiceConfiguration(HaproxyServiceConfiguration):
    ...
    def __init__(self, name, listen_socket, upstream_socket, **kwargs):
        super(HaproxyProxyServiceConfiguration, self).__init__(
    ...
    def generate_socket_config(self):
        ...
        socket_config.write(
            open('/etc/haproxy/system/%s' % socket_path, 'w'))
    ...
    def generate_proxy_config(self):
        ...
        service_config.write(
            open('/etc/haproxy/system/%s--proxy.service'
                 % self.ctrl_name,
                 'w'))
    ...
    def update_config(self):
        ...
        if self.service:
            super(HaproxyProxyServiceConfiguration, self).update_config()
